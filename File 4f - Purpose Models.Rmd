...
Dfinal2 <- Dprefinal %>%                    
  ...
  filter(!is.na(PA2016)) 
#Went from 20623 participants to 7516 participants
...
## Does the effect of Purpose on phyisical activity differ based on education, gender, or age?

```{r}
#Standardize the variables
Dfinal$Purpose68 = scale(Dfinal$Purpose68, center = TRUE, scale = TRUE)
Dfinal$Purpose1012 = scale(Dfinal$Purpose1012, center = TRUE, scale = TRUE)
...
```{r}
model1 <- lm(PA2016 ~ Purpose68 + Purpose1012, data = Dfinal)
summary(model1)
```
...
```{r}
model2 <- lm(PA2016 ~ Purpose68 + Purpose1012 + age + sex, data = Dfinal)
summary(model2)
```
...
```{r}
model3 <- lm(PA2016 ~ Purpose68 + Purpose1012 + age + sex + Income + edu + Race + Wealth, data = Dfinal)
summary(model3)
...
model3zyoung <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + edu + Race, data = Dfinal_younger)
summary(model3zyoung)

model3zold <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + edu + Race, data = Dfinal_older)
summary(model3zold)

model3zmale <- lm(PA2016 ~ Purpose68 + Purpose1012  + age + Income + edu + Race, data = Dfinal_male)
summary(model3zmale)

model3zfemale <- lm(PA2016 ~ Purpose68 + Purpose1012  + age + Income + edu + Race, data = Dfinal_female)
summary(model3zfemale)

model3zcollabove <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + age + Race, data = Dfinal_collabove)
summary(model3zcollabove)

model3zcollbelow <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + age + Race, data = Dfinal_collbelow)
...
model3zPosIncome <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + edu + Race, data = Dfinal_PosIncome)
summary(model3zPosIncome)

model3zNoIncome <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + edu + Race, data = Dfinal_NoIncome)
summary(model3zNoIncome)

model3zWhite <- lm(PA2016 ~ Purpose68 + Purpose1012  + age + Income + edu + Race, data = Dfinal_White)
summary(model3zWhite)

model3zBlack <- lm(PA2016 ~ Purpose68 + Purpose1012  + age + Income + edu + Race, data = Dfinal_Black)
summary(model3zBlack)

model3zWealthAbove <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + age + Race, data = Dfinal_WealthAbove)
summary(model3zWealthAbove)

model3zWealthBelow <- lm(PA2016 ~ Purpose68 + Purpose1012  + sex + Income + age + Race, data = Dfinal_WealthBelow)
...
# Testing Interaction Between Purpose and Social Demographic Factors
## Evaluate the p value of Purpose*factor

## Model 4a

```{r}
model4a <- lm(PA2016 ~ Purpose68 + Purpose1012*age + sex + Income + edu + Race + Wealth , data = Dfinal)
summary(model4a)
```
...
```{r}
model4s <- lm(PA2016 ~ Purpose68 + Purpose1012*sex + age + Income + edu + Race + Wealth , data = Dfinal)
summary(model4s)
```
...
```{r}
model4i <- lm(PA2016 ~ Purpose68 + Purpose1012*Income + age + sex + edu + Race + Wealth , data = Dfinal)
summary(model4i)
```
...
```{r}
model4e <- lm(PA2016 ~ Purpose68 + Purpose1012*edu + age + sex + Income + Race + Wealth , data = Dfinal)
summary(model4e)
```
...
```{r}
model4r <- lm(PA2016 ~ Purpose68 + Purpose1012*Race + age + sex + edu + Income + Wealth , data = Dfinal)
summary(model4r)
```
...
```{r}
model4w <- lm(PA2016 ~ Purpose68 + Purpose1012*Wealth + age + sex + edu + Race + Income , data = Dfinal)
summary(model4w)
```
...
```{r}
#Extracting coefficients and confidence intervals for "Purpose1012" from each model
ci1 <- confint(model3zyoung, "Purpose1012", level = 0.95)
ci2 <- confint(model3zold, "Purpose1012", level = 0.95)
ci3 <- confint(model3zmale, "Purpose1012", level = 0.95)
ci4 <- confint(model3zfemale, "Purpose1012", level = 0.95)
ci5 <- confint(model3zPosIncome, "Purpose1012", level = 0.95)
ci6 <- confint(model3zNoIncome, "Purpose1012", level = 0.95)
ci7 <- confint(model3zcollabove, "Purpose1012", level = 0.95)
ci8 <- confint(model3zcollbelow, "Purpose1012", level = 0.95)
ci9 <- confint(model3zWhite, "Purpose1012", level = 0.95)
ci10 <- confint(model3zBlack, "Purpose1012", level = 0.95)
ci11 <- confint(model3zWealthAbove, "Purpose1012", level = 0.95)
ci12 <- confint(model3zWealthBelow, "Purpose1012", level = 0.95)

#Combine the confidence intervals into a data frame in the desired order
df_combined <- bind_rows(
  data.frame(Term = "Purpose1012", Model = "model3zWealthBelow", Estimate = coef(model3zWealthBelow)["Purpose1012"], CI.Lower = ci12[1], CI.Upper = ci12[2]),
  data.frame(Term = "Purpose1012", Model = "model3zWealthAbove", Estimate = coef(model3zWealthAbove)["Purpose1012"], CI.Lower = ci11[1], CI.Upper = ci11[2]),
  data.frame(Term = "Purpose1012", Model = "model3zNoIncome", Estimate = coef(model3zNoIncome)["Purpose1012"], CI.Lower = ci6[1], CI.Upper = ci6[2]),
  data.frame(Term = "Purpose1012", Model = "model3zPosIncome", Estimate = coef(model3zPosIncome)["Purpose1012"], CI.Lower = ci5[1], CI.Upper = ci5[2]),
  data.frame(Term = "Purpose1012", Model = "model3zcollbelow", Estimate = coef(model3zcollbelow)["Purpose1012"], CI.Lower = ci8[1], CI.Upper = ci8[2]),
  data.frame(Term = "Purpose1012", Model = "model3zcollabove", Estimate = coef(model3zcollabove)["Purpose1012"], CI.Lower = ci7[1], CI.Upper = ci7[2]),
  data.frame(Term = "Purpose1012", Model = "model3zBlack", Estimate = coef(model3zBlack)["Purpose1012"], CI.Lower = ci10[1], CI.Upper = ci10[2]),
  data.frame(Term = "Purpose1012", Model = "model3zWhite", Estimate = coef(model3zWhite)["Purpose1012"], CI.Lower = ci9[1], CI.Upper = ci9[2]),
  data.frame(Term = "Purpose1012", Model = "model3zfemale", Estimate = coef(model3zfemale)["Purpose1012"], CI.Lower = ci4[1], CI.Upper = ci4[2]),
  data.frame(Term = "Purpose1012", Model = "model3zmale", Estimate = coef(model3zmale)["Purpose1012"], CI.Lower = ci3[1], CI.Upper = ci3[2]),
  data.frame(Term = "Purpose1012", Model = "model3zold", Estimate = coef(model3zold)["Purpose1012"], CI.Lower = ci2[1], CI.Upper = ci2[2]),
  data.frame(Term = "Purpose1012", Model = "model3zyoung", Estimate = coef(model3zyoung)["Purpose1012"], CI.Lower = ci1[1], CI.Upper = ci1[2])
)
...
plot(c(df_combined$CI.Lower, df_combined$CI.Upper), 
     ...
     type = "n", 
     xlab = "Coefficient Estimate for 'Purpose'", 
     ylab = "", 
     xaxt = "n", 
     yaxt = "n", 
     xlim = c(-1, 2),
...
mtext("Effects of Purpose on Physical Activity", side = 3, line = -3, outer = TRUE, cex = 1, font = 2)  #Adjust title font size
